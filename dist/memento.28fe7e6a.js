...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"memento.ts":[function(require,module,exports) {
"use strict";

var Memento =
/** @class */
function () {
  function Memento(_article) {
    this._article = _article;
  }

  Object.defineProperty(Memento.prototype, "article", {
    get: function get() {
      return this._article;
    },
    set: function set(art) {
      this._article = art;
    },
    enumerable: true,
    configurable: true
...
function () {
  ...
  Caretaker.prototype.getMemento = function (i) {
...
function onSave() {
  ...
  var m = originator.storeInMemento();
...
function onUndo() {
  if (currentArticle >= 1) {
    currentArticle--;
    var m = caretaker.getMemento(currentArticle);
    var text = originator.restoreFromMemento(m);
    textarea.value = text;
  }
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7639" + '/');
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","memento.ts"], null)
//# sourceMappingURL=/memento.28fe7e6a.js.map