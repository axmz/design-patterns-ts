...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"decorator.ts":[function(require,module,exports) {
"use strict";
...
var ToppingDecorator =
/** @class */
function () {
  function ToppingDecorator(newPizza) {
...
function (_super) {
  ...
  function Mozzarella(newPizza) {
    var _this = _super.call(this, newPizza) || this;

    _this.newPizza = newPizza;
    return _this;
  }

  Mozzarella.prototype.getDescription = function () {
    return this.tempPizza.getDescription() + " + Mozzarella";
  };

  Mozzarella.prototype.getCost = function () {
...
/** @class */
function (_super) {
  __extends(TomatoSauce, _super);

  function TomatoSauce(newPizza) {
    var _this = _super.call(this, newPizza) || this;
  ...
  TomatoSauce.prototype.getDescription = function () {
    return this.tempPizza.getDescription() + " + Tomato Sauce";
  };

  TomatoSauce.prototype.getCost = function () {
...
var pizza = new Mozzarella(new TomatoSauce(new PlainPizza()));
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","decorator.ts"], null)
//# sourceMappingURL=/decorator.bd0d6abf.js.map